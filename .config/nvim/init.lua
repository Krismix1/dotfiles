...
require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'vim', 'javascript', 'markdown',
        'scss', 'css', 'bash', 'dockerfile', 'diff', 'gitignore', 'jsonc', 'toml', 'yaml', 'html' },
...
local is_poetry = utils.exists("./poetry.lock") or utils.exists("./pyproject.toml")
local venv = nil
if is_poetry then
    venv = utils.get_python_path_poetry_venv("./")
end
...
local servers = {
    ...
    --     client.config.settings.python.pythonPath = utils.get_python_path_poetry_venv(client.config.root_dir)
    -- end
    -- },
    pylsp = {},
    rust_analyzer = {},
