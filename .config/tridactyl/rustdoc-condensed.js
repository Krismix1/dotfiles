// Courtesy of BurntSushi
// https://github.com/BurntSushi/dotfiles/blob/23d16fd3ab4aa627ce646dac5b171c7ebbf5631c/.config/tridactyl/rustdoc-condensed.js
(function () {
  ...
  //
  // rustdoc does seemingly have user settings that surport to make this the
  ...
  // selected method.
  //
  // I used the tridactyl Firefox extension to bind this script to `zz` with
  // the following in my tridactylrc:
  //
  //     bind zz composite jsb tri.native.run('cat path/to/rustdoc-condensed.js') | js -p eval(JS_ARG.content)
